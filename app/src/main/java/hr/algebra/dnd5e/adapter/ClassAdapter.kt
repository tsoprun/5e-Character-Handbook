...
class ClassAdapter (
    ...
    private val classes: List<ClassRef>,
    private val onClick:(ClassRef) -> Unit
    ...
    override fun onBindViewHolder(
        ...
        holder.bind(charClass, charClass.name==selectedName)
        holder.itemView.setOnClickListener {onClick(charClass)}
    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(charClass: ClassRef, isSelected: Boolean) {
            tvName.text=charClass.name
